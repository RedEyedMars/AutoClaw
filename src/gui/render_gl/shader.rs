use gl;
use crate::gui::resources::{self, Resources};
use std;
...
impl Program {
    ...
    pub fn from_shaders(gl: &gl::Gl, shaders: &[Shader]) -> Result<Program, String> {
        ...
        unsafe {
            let _tex_coord_shift_loc = gl.GetUniformLocation(program_id, CString::new("TexCoordShift").expect("CString::new failed").as_ptr());
            Ok(Program {
                gl: gl.clone(),
                id: program_id,
    ...
    pub fn get_location(&self,loc: &str ) -> gl::types::GLint {
        ...
        unsafe { return self.gl.GetUniformLocation(self.id, c_ptr.as_ptr()); }
    }
